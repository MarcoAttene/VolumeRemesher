...
inline int orient2d_interval(interval_number p1x, interval_number p1y,
                             interval_number p2x, interval_number p2y,
...
inline int orient2d_exact(double p1x, double p1y, double p2x, double p2y,
                          double p3x, double p3y) {
...
inline int orient2d(double p1x, double p1y, double p2x, double p2y, double p3x,
                    double p3y) {
...
inline int orient3d_filtered(double px, double py, double pz, double qx,
...
inline int orient3d_interval(interval_number px, interval_number py,
...
inline void supo3d1(expansionObject &o, double *c1, double *c2, double *c3,
                    double *c4, double *c5, double *c6, double *a1, double *a2,
                    double &i, double *k1, double *k2, double *k3, double *k4,
                    int &l1, int &l2) {
  if (c1[0] == 0.0) {
    if (c2[0] == 0.0) {
      a1[0] = a2[0] = 0.0;
...
inline void supo3d2(expansionObject &o, double *c1, double *c2, double *c3,
                    double *c4, double *u, int &fl, double fin[2][192], int &wh,
...
inline int orient3d_exact(double pdx, double pdy, double pdz, double pax,
  ...
  supo3d1(o, adx, ady, bdx, cdx, bdy, cdy, at_b, at_c, inv, adxt_bdy, adyt_bdx,
          adyt_cdx, adxt_cdy, at_blen, at_clen);

  supo3d1(o, bdx, bdy, cdx, adx, cdy, ady, bt_c, bt_a, inv, bdxt_cdy, bdyt_cdx,
          bdyt_adx, bdxt_ady, bt_alen, bt_clen);

  supo3d1(o, cdx, cdy, adx, bdx, ady, bdy, ct_a, ct_b, inv, cdxt_ady, cdyt_adx,
  ...
  supo3d2(o, adx, bdy, adxt_bdyt, cdz, u, finlen, fin, wh, cdy, inv, adxt_cdyt,
          bdz);
  supo3d2(o, bdx, cdy, bdxt_cdyt, adz, u, finlen, fin, wh, ady, inv, bdxt_adyt,
          cdz);
  supo3d2(o, cdx, ady, cdxt_adyt, bdz, u, finlen, fin, wh, bdy, inv, cdxt_bdyt,
          adz);
...
inline int orient3d(double px, double py, double pz, double qx, double qy,
