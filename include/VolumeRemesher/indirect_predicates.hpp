...
inline int incircle_filtered(double pax, double pay, double pbx, double pby,
  ...
  if (L > epsilon)
    return IP_Sign::POSITIVE;
  if (-L > epsilon)
    return IP_Sign::NEGATIVE;
  return Filtered_Sign::UNCERTAIN;
}

inline int incircle_interval(interval_number pax, interval_number pay,
                             interval_number pbx, interval_number pby,
                             interval_number pcx, interval_number pcy,
                             interval_number pdx, interval_number pdy) {
  setFPUModeToRoundUP();
...
inline int incircle_bigfloat(bigfloat pax, bigfloat pay, bigfloat pbx,
                             bigfloat pby, bigfloat pcx, bigfloat pcy,
                             bigfloat pdx, bigfloat pdy) {
...
inline int incircle_exact(double pax, double pay, double pbx, double pby,
                          double pcx, double pcy, double pdx, double pdy) {
  expansionObject o;
  double adx[2];
...
inline int incircle(double pax, double pay, double pbx, double pby, double pcx,
                    double pcy, double pdx, double pdy) {
  int ret;
  ret = incircle_filtered(pax, pay, pbx, pby, pcx, pcy, pdx, pdy);
  if (ret != Filtered_Sign::UNCERTAIN)
    return ret;
...
inline int inSphere_filtered(double pax, double pay, double paz, double pbx,
...
inline int inSphere_interval(interval_number pax, interval_number pay,
                             interval_number paz, interval_number pbx,
                             interval_number pby, interval_number pbz,
                             interval_number pcx, interval_number pcy,
                             interval_number pcz, interval_number pdx,
                             interval_number pdy, interval_number pdz,
                             interval_number pex, interval_number pey,
                             interval_number pez) {
  setFPUModeToRoundUP();
...
inline int inSphere_bigfloat(bigfloat pax, bigfloat pay, bigfloat paz,
                             bigfloat pbx, bigfloat pby, bigfloat pbz,
                             bigfloat pcx, bigfloat pcy, bigfloat pcz,
                             bigfloat pdx, bigfloat pdy, bigfloat pdz,
                             bigfloat pex, bigfloat pey, bigfloat pez) {
...
inline int inSphere_exact(double pax, double pay, double paz, double pbx,
                          double pby, double pbz, double pcx, double pcy,
                          double pcz, double pdx, double pdy, double pdz,
                          double pex, double pey, double pez) {
  expansionObject o;
...
inline int inSphere(double pax, double pay, double paz, double pbx, double pby,
  ...
  if (ret != Filtered_Sign::UNCERTAIN)
    return ret;
  ret = inSphere_interval(pax, pay, paz, pbx, pby, pbz, pcx, pcy, pcz, pdx, pdy,
                          pdz, pex, pey, pez);
  if (ret != Filtered_Sign::UNCERTAIN)
    return ret;
  return inSphere_exact(pax, pay, paz, pbx, pby, pbz, pcx, pcy, pcz, pdx, pdy,
                        pdz, pex, pey, pez);
}

inline int
incirclexy_indirect_IEEE_interval(const genericPoint &p1, interval_number pbx,
                                  interval_number pby, interval_number pcx,
                                  interval_number pcy, interval_number pdx,
                                  interval_number pdy) {
...
inline int incirclexy_indirect_IEEE_bigfloat(const genericPoint &p1,
                                             bigfloat pbx, bigfloat pby,
                                             bigfloat pcx, bigfloat pcy,
                                             bigfloat pdx, bigfloat pdy) {
...
inline int incirclexy_indirect_IEEE_exact(const genericPoint &p1, double pbx,
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int la_len = o.Gen_Product_With_PreAlloc(alift_len, alift, bcdet_len, bcdet,
                                             &la, 64);
    double lbt_p[64], *lbt = lbt_p;
    int lbt_len = o.Gen_Product_With_PreAlloc(blift_len, blift, cadet_len,
                                              cadet, &lbt, 64);
    double lb_p[64], *lb = lb_p;
    int lb_len = o.Gen_Product_With_PreAlloc(lbt_len, lbt, d1_len, d1, &lb, 64);
    double lct_p[64], *lct = lct_p;
    int lct_len = o.Gen_Product_With_PreAlloc(clift_len, clift, abdet_len,
                                              abdet, &lct, 64);
  ...
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value =
        incirclexy_indirect_IEEE_bigfloat(p1, pbx, pby, pcx, pcy, pdx, pdy);
#endif
...
inline int incirclexy_indirect_IEEE(const genericPoint &p1, double pbx,
                                    double pby, double pcx, double pcy,
                                    double pdx, double pdy) {
  int ret;
...
inline int incirclexy_indirect_IIEE_interval(
    const genericPoint &p1, const genericPoint &p2, interval_number pcx,
    interval_number pcy, interval_number pdx, interval_number pdy) {
...
inline int incirclexy_indirect_IIEE_exact(const genericPoint &p1,
                                          const genericPoint &p2, double pcx,
                                          double pcy, double pdx, double pdy) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    int lb_len = o.Gen_Product_With_PreAlloc(blift_len, blift, cadet_len, cadet,
                                             &lb, 32);
    double lc_p[32], *lc = lc_p;
    int lc_len = o.Gen_Product_With_PreAlloc(clift_len, clift, abdet_len, abdet,
                                             &lc, 32);
  ...
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value =
        incirclexy_indirect_IIEE_bigfloat(p1, p2, pcx, pcy, pdx, pdy);
#endif
...
inline int incirclexy_indirect_IIIE_exact(const genericPoint &p1,
                                          const genericPoint &p2,
                                          const genericPoint &p3, double pdx,
                                          double pdy) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
    ...
    int alift2_len = o.Gen_Product_With_PreAlloc(aliftt_len, aliftt, d2_len, d2,
                                                 &alift2, 32);
    double alift_p[32], *alift = alift_p;
    int alift_len =
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = incirclexy_indirect_IIIE_bigfloat(p1, p2, p3, pdx, pdy);
#endif
...
inline int incirclexy_indirect_IIII_interval(const genericPoint &p1,
  ...
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3, l4x,
      l4y, l4z, d4;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
      !p2.getIntervalLambda(l2x, l2y, l2z, d2) ||
      !p3.getIntervalLambda(l3x, l3y, l3z, d3) ||
...
inline int incirclexy_indirect_IIII_bigfloat(const genericPoint &p1,
                                             ...
                                             const genericPoint &p3,
                                             const genericPoint &p4) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3, l4x, l4y,
      l4z, d4;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
  p2.getBigfloatLambda(l2x, l2y, l2z, d2);
  p3.getBigfloatLambda(l3x, l3y, l3z, d3);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = incirclexy_indirect_IIII_bigfloat(p1, p2, p3, p4);
#endif
...
inline int
incircle_indirect_IEEE_interval(const genericPoint &p1, interval_number pbx,
                                interval_number pby, interval_number pcx,
                                interval_number pcy, interval_number pdx,
                                interval_number pdy) {
...
inline int incircle_indirect_IEEE_bigfloat(const genericPoint &p1, bigfloat pbx,
                                           bigfloat pby, bigfloat pcx,
                                           bigfloat pcy, bigfloat pdx,
                                           bigfloat pdy) {
  bigfloat l1x, l1y, d1;
...
inline int incircle_indirect_IEEE_exact(const genericPoint &p1, double pbx,
                                        double pby, double pcx, double pcy,
                                        double pdx, double pdy) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value =
        incircle_indirect_IEEE_bigfloat(p1, pbx, pby, pcx, pcy, pdx, pdy);
#endif
...
inline int incircle_indirect_IEEE(const genericPoint &p1, double pbx,
                                  double pby, double pcx, double pcy,
                                  double pdx, double pdy) {
  int ret;
...
inline int
incircle_indirect_IIEE_interval(const genericPoint &p1, const genericPoint &p2,
                                interval_number pcx, interval_number pcy,
                                interval_number pdx, interval_number pdy) {
...
inline int incircle_indirect_IIEE_bigfloat(const genericPoint &p1,
                                           const genericPoint &p2, bigfloat pcx,
                                           bigfloat pcy, bigfloat pdx,
                                           bigfloat pdy) {
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = incircle_indirect_IIEE_bigfloat(p1, p2, pcx, pcy, pdx, pdy);
#endif
...
inline int incircle_indirect_IIIE_bigfloat(const genericPoint &p1,
                                           const genericPoint &p2,
                                           const genericPoint &p3, bigfloat pdx,
                                           bigfloat pdy) {
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = incircle_indirect_IIIE_bigfloat(p1, p2, p3, pdx, pdy);
#endif
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = incircle_indirect_IIII_bigfloat(p1, p2, p3, p4);
#endif
...
inline int inSphere_IEEEE_interval(const genericPoint &p1, interval_number pbx,
                                   interval_number pby, interval_number pbz,
                                   interval_number pcx, interval_number pcy,
                                   interval_number pcz, interval_number pdx,
                                   interval_number pdy, interval_number pdz,
...
inline int inSphere_IEEEE_bigfloat(const genericPoint &p1, bigfloat pbx,
                                   bigfloat pby, bigfloat pbz, bigfloat pcx,
                                   bigfloat pcy, bigfloat pcz, bigfloat pdx,
                                   bigfloat pdy, bigfloat pdz, bigfloat pex,
                                   bigfloat pey, bigfloat pez) {
  bigfloat l1x, l1y, l1z, d1;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
...
inline int inSphere_IEEEE_exact(const genericPoint &p1, double pbx, double pby,
                                double pbz, double pcx, double pcy, double pcz,
                                double pdx, double pdy, double pdz, double pex,
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int ab_len = o.Gen_Diff_With_PreAlloc(aexbey_len, aexbey, bexaey_len,
                                          bexaey, &ab, 16);
    double bexcey[8];
    int bexcey_len = o.Gen_Product(2, bex, 2, cey, bexcey);
    double cexbey[8];
    ...
    int da_len = o.Gen_Diff_With_PreAlloc(dexaey_len, dexaey, aexdey_len,
                                          aexdey, &da, 16);
    ...
    int ac_len = o.Gen_Diff_With_PreAlloc(aexcey_len, aexcey, cexaey_len,
                                          cexaey, &ac, 16);
    double bexdey[8];
    int bexdey_len = o.Gen_Product(2, bex, 2, dey, bexdey);
    double dexbey[8];
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = inSphere_IEEEE_bigfloat(p1, pbx, pby, pbz, pcx, pcy, pcz,
                                           pdx, pdy, pdz, pex, pey, pez);
#endif
...
inline int inSphere_IEEEE(const genericPoint &p1, double pbx, double pby,
                          double pbz, double pcx, double pcy, double pcz,
                          double pdx, double pdy, double pdz, double pex,
                          double pey, double pez) {
  int ret;
  ret = inSphere_IEEEE_interval(p1, pbx, pby, pbz, pcx, pcy, pcz, pdx, pdy, pdz,
                                pex, pey, pez);
  if (ret != Filtered_Sign::UNCERTAIN)
    return ret;
  return inSphere_IEEEE_exact(p1, pbx, pby, pbz, pcx, pcy, pcz, pdx, pdy, pdz,
                              pex, pey, pez);
}

inline int inSphere_IIEEE_interval(const genericPoint &p1,
                                   const genericPoint &p2, interval_number pcx,
                                   interval_number pcy, interval_number pcz,
                                   interval_number pdx, interval_number pdy,
                                   interval_number pdz, interval_number pex,
                                   interval_number pey, interval_number pez) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
      !p2.getIntervalLambda(l2x, l2y, l2z, d2))
    return Filtered_Sign::UNCERTAIN;
...
inline int inSphere_IIEEE_exact(const genericPoint &p1, const genericPoint &p2,
                                double pcx, double pcy, double pcz, double pdx,
                                double pdy, double pdz, double pex, double pey,
                                double pez) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    int bc_len = o.Gen_Diff_With_PreAlloc(bexcey_len, bexcey, cexbey_len,
                                          cexbey, &bc, 16);
    double cexdey[8];
    int cexdey_len = o.Gen_Product(2, cex, 2, dey, cexdey);
    double dexcey[8];
    ...
    int bd_len = o.Gen_Diff_With_PreAlloc(bexdey_len, bexdey, dexbey_len,
                                          dexbey, &bd, 16);
    double abc1_p[16], *abc1 = abc1_p;
    int abc1_len =
        o.Gen_Product_With_PreAlloc(aez_len, aez, bc_len, bc, &abc1, 16);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = inSphere_IIEEE_bigfloat(p1, p2, pcx, pcy, pcz, pdx, pdy, pdz,
                                           pex, pey, pez);
#endif
...
inline int inSphere_IIEEE(const genericPoint &p1, const genericPoint &p2,
                          double pcx, double pcy, double pcz, double pdx,
                          double pdy, double pdz, double pex, double pey,
                          double pez) {
  int ret;
  ret = inSphere_IIEEE_interval(p1, p2, pcx, pcy, pcz, pdx, pdy, pdz, pex, pey,
                                pez);
  if (ret != Filtered_Sign::UNCERTAIN)
    return ret;
  return inSphere_IIEEE_exact(p1, p2, pcx, pcy, pcz, pdx, pdy, pdz, pex, pey,
                              pez);
}

inline int inSphere_IIIEE_interval(const genericPoint &p1,
                                   const genericPoint &p2,
                                   const genericPoint &p3, interval_number pdx,
                                   interval_number pdy, interval_number pdz,
                                   interval_number pex, interval_number pey,
                                   interval_number pez) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
...
inline int inSphere_IIIEE_exact(const genericPoint &p1, const genericPoint &p2,
                                const genericPoint &p3, double pdx, double pdy,
                                double pdz, double pex, double pey,
                                double pez) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
    ...
    int cd_len = o.Gen_Diff_With_PreAlloc(cexdey_len, cexdey, dexcey_len,
                                          dexcey, &cd, 16);
    double dexaey_p[16], *dexaey = dexaey_p;
    int dexaey_len =
        o.Gen_Product_With_PreAlloc(2, dex, aey_len, aey, &dexaey, 16);
  ...
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value =
        inSphere_IIIEE_bigfloat(p1, p2, p3, pdx, pdy, pdz, pex, pey, pez);
#endif
...
inline int inSphere_IIIEE(const genericPoint &p1, const genericPoint &p2,
                          const genericPoint &p3, double pdx, double pdy,
...
inline int inSphere_IIIIE_interval(const genericPoint &p1,
                                   const genericPoint &p2,
                                   const genericPoint &p3,
                                   const genericPoint &p4, interval_number pex,
                                   interval_number pey, interval_number pez) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3, l4x,
      l4y, l4z, d4;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
...
inline int inSphere_IIIIE_bigfloat(const genericPoint &p1,
                                   const genericPoint &p2,
                                   const genericPoint &p3,
                                   const genericPoint &p4, bigfloat pex,
                                   bigfloat pey, bigfloat pez) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3, l4x, l4y,
      l4z, d4;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
...
inline int inSphere_IIIIE_exact(const genericPoint &p1, const genericPoint &p2,
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = inSphere_IIIIE_bigfloat(p1, p2, p3, p4, pex, pey, pez);
#endif
...
inline int inSphere_IIIIE(const genericPoint &p1, const genericPoint &p2,
                          const genericPoint &p3, const genericPoint &p4,
                          double pex, double pey, double pez) {
  int ret;
...
inline int inSphere_IIIII_exact(const genericPoint &p1, const genericPoint &p2,
                                const genericPoint &p3, const genericPoint &p4,
                                const genericPoint &p5) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = inSphere_IIIII_bigfloat(p1, p2, p3, p4, p5);
#endif
...
inline int inSphere_IIIII(const genericPoint &p1, const genericPoint &p2,
                          const genericPoint &p3, const genericPoint &p4,
                          const genericPoint &p5) {
  int ret;
...
inline bool lambda2d_SSI_interval(interval_number ea1x, interval_number ea1y,
...
inline void lambda2d_SSI_bigfloat(bigfloat ea1x, bigfloat ea1y, bigfloat ea2x,
                                  bigfloat ea2y, bigfloat eb1x, bigfloat eb1y,
                                  bigfloat eb2x, bigfloat eb2y,
...
inline void lambda2d_SSI_exact(double ea1x, double ea1y, double ea2x,
...
inline bool lambda3d_LNC_interval(interval_number px, interval_number py,
...
inline void lambda3d_LNC_bigfloat(bigfloat px, bigfloat py, bigfloat pz,
                                  bigfloat qx, bigfloat qy, bigfloat qz,
                                  bigfloat t, bigfloat &lambda_x,
                                  bigfloat &lambda_y, bigfloat &lambda_z,
                                  bigfloat &lambda_d) {
...
inline void lambda3d_LNC_exact(double px, double py, double pz, double qx,
...
inline bool lambda3d_LPI_interval(
    interval_number px, interval_number py, interval_number pz,
    interval_number qx, interval_number qy, interval_number qz,
    interval_number rx, interval_number ry, interval_number rz,
    interval_number sx, interval_number sy, interval_number sz,
    interval_number tx, interval_number ty, interval_number tz,
...
inline void lambda3d_LPI_bigfloat(bigfloat px, bigfloat py, bigfloat pz,
                                  bigfloat qx, bigfloat qy, bigfloat qz,
                                  bigfloat rx, bigfloat ry, bigfloat rz,
                                  bigfloat sx, bigfloat sy, bigfloat sz,
...
inline void lambda3d_LPI_exact(double px, double py, double pz, double qx,
  ...
  lambda_x_len = o.Gen_Diff_With_PreAlloc(dpx_len, dpx, ax_len, ax, lambda_x,
                                          lambda_x_len);
  lambda_y_len = o.Gen_Diff_With_PreAlloc(dpy_len, dpy, ay_len, ay, lambda_y,
                                          lambda_y_len);
  lambda_z_len = o.Gen_Diff_With_PreAlloc(dpz_len, dpz, az_len, az, lambda_z,
                                          lambda_z_len);
  lambda_d_len = o.Gen_Sum_With_PreAlloc(tt1_len, tt1, tv9_len, tv9, lambda_d,
                                         lambda_d_len);
...
inline void lambda3d_TPI_bigfloat(
...
inline void lambda3d_TPI_exact(
    double ov1x, double ov1y, double ov1z, double ov2x, double ov2y,
    double ov2z, double ov3x, double ov3y, double ov3z, double ow1x,
    double ow1y, double ow1z, double ow2x, double ow2y, double ow2z,
    double ow3x, double ow3y, double ow3z, double ou1x, double ou1y,
    double ou1z, double ou2x, double ou2y, double ou2z, double ou3x,
    double ou3y, double ou3z, double **lambda_x, int &lambda_x_len,
  ...
  lambda_d_len = o.Gen_Diff_With_PreAlloc(dab_len, dab, dc_len, dc, lambda_d,
                                          lambda_d_len);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = lessThanOnX_IE_bigfloat(p1, bx);
#endif
...
inline int lessThanOnX_II_interval(const genericPoint &p1,
                                   const genericPoint &p2) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
      !p2.getIntervalLambda(l2x, l2y, l2z, d2))
...
inline int lessThanOnX_II_bigfloat(const genericPoint &p1,
                                   const genericPoint &p2) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
  p2.getBigfloatLambda(l2x, l2y, l2z, d2);
...
inline int lessThanOnX_II_exact(const genericPoint &p1,
                                const genericPoint &p2) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = lessThanOnX_II_bigfloat(p1, p2);
#endif
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = lessThanOnY_IE_bigfloat(p1, by);
#endif
...
inline int lessThanOnY_II_interval(const genericPoint &p1,
                                   const genericPoint &p2) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
      !p2.getIntervalLambda(l2x, l2y, l2z, d2))
...
inline int lessThanOnY_II_bigfloat(const genericPoint &p1,
                                   const genericPoint &p2) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
  p2.getBigfloatLambda(l2x, l2y, l2z, d2);
...
inline int lessThanOnY_II_exact(const genericPoint &p1,
                                const genericPoint &p2) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = lessThanOnY_II_bigfloat(p1, p2);
#endif
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = lessThanOnZ_IE_bigfloat(p1, bz);
#endif
...
inline int lessThanOnZ_II_interval(const genericPoint &p1,
                                   const genericPoint &p2) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
      !p2.getIntervalLambda(l2x, l2y, l2z, d2))
...
inline int lessThanOnZ_II_bigfloat(const genericPoint &p1,
                                   const genericPoint &p2) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
  p2.getBigfloatLambda(l2x, l2y, l2z, d2);
...
inline int lessThanOnZ_II_exact(const genericPoint &p1,
                                const genericPoint &p2) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = lessThanOnZ_II_bigfloat(p1, p2);
#endif
...
inline int orient2dxy_indirect_IEE_bigfloat(const genericPoint &p1,
                                            bigfloat p2x, bigfloat p2y,
                                            bigfloat p3x, bigfloat p3y) {
  bigfloat l1x, l1y, l1z, d1;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
...
inline int orient2dxy_indirect_IEE_exact(const genericPoint &p1, double p2x,
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dxy_indirect_IEE_bigfloat(p1, p2x, p2y, p3x, p3y);
#endif
...
inline int orient2dxy_indirect_IEE(const genericPoint &p1, double p2x,
                                   double p2y, double p3x, double p3y) {
  int ret;
...
inline int orient2dxy_indirect_IIE_bigfloat(const genericPoint &p1,
                                            const genericPoint &p2,
                                            bigfloat op3x, bigfloat op3y) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
  p2.getBigfloatLambda(l2x, l2y, l2z, d2);
...
inline int orient2dxy_indirect_IIE_exact(const genericPoint &p1,
                                         const genericPoint &p2, double op3x,
                                         double op3y) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dxy_indirect_IIE_bigfloat(p1, p2, op3x, op3y);
#endif
...
inline int orient2dxy_indirect_IIE(const genericPoint &p1,
                                   const genericPoint &p2, double op3x,
                                   double op3y) {
  int ret;
...
inline int orient2dxy_indirect_III_interval(const genericPoint &p1,
                                            const genericPoint &p2,
                                            const genericPoint &p3) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
...
inline int orient2dxy_indirect_III_bigfloat(const genericPoint &p1,
                                            const genericPoint &p2,
                                            const genericPoint &p3) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
...
inline int orient2dxy_indirect_III_exact(const genericPoint &p1,
                                         const genericPoint &p2,
                                         const genericPoint &p3) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dxy_indirect_III_bigfloat(p1, p2, p3);
#endif
...
inline int orient2dxy_indirect_III(const genericPoint &p1,
                                   const genericPoint &p2,
                                   const genericPoint &p3) {
  int ret;
...
inline int orient2dyz_indirect_IEE_interval(const genericPoint &p1,
  ...
  if (!p1.getIntervalLambda(l1z, l1x, l1y, d1))
    return Filtered_Sign::UNCERTAIN;
...
inline int orient2dyz_indirect_IEE_bigfloat(const genericPoint &p1,
                                            bigfloat p2x, bigfloat p2y,
                                            bigfloat p3x, bigfloat p3y) {
...
inline int orient2dyz_indirect_IEE_exact(const genericPoint &p1, double p2x,
                                         double p2y, double p3x, double p3y) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dyz_indirect_IEE_bigfloat(p1, p2x, p2y, p3x, p3y);
#endif
...
inline int orient2dyz_indirect_IEE(const genericPoint &p1, double p2x,
                                   double p2y, double p3x, double p3y) {
  int ret;
...
inline int orient2dyz_indirect_IIE_bigfloat(const genericPoint &p1,
                                            const genericPoint &p2,
                                            bigfloat op3x, bigfloat op3y) {
...
inline int orient2dyz_indirect_IIE_exact(const genericPoint &p1,
                                         const genericPoint &p2, double op3x,
                                         double op3y) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
#endif
  double l1z_p[64], *l1z = l1z_p, l1x_p[64], *l1x = l1x_p, l1y_p[64],
                    *l1y = l1y_p, d1_p[64], *d1 = d1_p, l2z_p[64], *l2z = l2z_p,
                    l2x_p[64], *l2x = l2x_p, l2y_p[64], *l2y = l2y_p, d2_p[64],
                    *d2 = d2_p;
  int l1z_len = 64, l1x_len = 64, l1y_len = 64, d1_len = 64, l2z_len = 64,
      l2x_len = 64, l2y_len = 64, d2_len = 64;
  p1.getExactLambda(&l1z, l1z_len, &l1x, l1x_len, &l1y, l1y_len, &d1, d1_len);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dyz_indirect_IIE_bigfloat(p1, p2, op3x, op3y);
#endif
...
inline int orient2dyz_indirect_IIE(const genericPoint &p1,
                                   const genericPoint &p2, double op3x,
                                   double op3y) {
  int ret;
...
inline int orient2dyz_indirect_III_interval(const genericPoint &p1,
                                            const genericPoint &p2,
                                            const genericPoint &p3) {
...
inline int orient2dyz_indirect_III_bigfloat(const genericPoint &p1,
                                            const genericPoint &p2,
                                            const genericPoint &p3) {
...
inline int orient2dyz_indirect_III_exact(const genericPoint &p1,
                                         const genericPoint &p2,
                                         const genericPoint &p3) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  double l1z_p[64], *l1z = l1z_p, l1x_p[64], *l1x = l1x_p, l1y_p[64],
                    *l1y = l1y_p, d1_p[64], *d1 = d1_p, l2z_p[64], *l2z = l2z_p,
                    l2x_p[64], *l2x = l2x_p, l2y_p[64], *l2y = l2y_p, d2_p[64],
                    *d2 = d2_p, l3z_p[64], *l3z = l3z_p, l3x_p[64],
                    *l3x = l3x_p, l3y_p[64], *l3y = l3y_p, d3_p[64], *d3 = d3_p;
  int l1z_len = 64, l1x_len = 64, l1y_len = 64, d1_len = 64, l2z_len = 64,
      l2x_len = 64, l2y_len = 64, d2_len = 64, l3z_len = 64, l3x_len = 64,
      l3y_len = 64, d3_len = 64;
  p1.getExactLambda(&l1z, l1z_len, &l1x, l1x_len, &l1y, l1y_len, &d1, d1_len);
  p2.getExactLambda(&l2z, l2z_len, &l2x, l2x_len, &l2y, l2y_len, &d2, d2_len);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dyz_indirect_III_bigfloat(p1, p2, p3);
#endif
...
inline int orient2dyz_indirect_III(const genericPoint &p1,
                                   const genericPoint &p2,
                                   const genericPoint &p3) {
  int ret;
...
inline int orient2dzx_indirect_IEE_interval(const genericPoint &p1,
  ...
  if (!p1.getIntervalLambda(l1y, l1z, l1x, d1))
    return Filtered_Sign::UNCERTAIN;
...
inline int orient2dzx_indirect_IEE_bigfloat(const genericPoint &p1,
                                            bigfloat p2x, bigfloat p2y,
                                            bigfloat p3x, bigfloat p3y) {
...
inline int orient2dzx_indirect_IEE_exact(const genericPoint &p1, double p2x,
                                         double p2y, double p3x, double p3y) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
#endif
  double l1y_p[128], *l1y = l1y_p, l1z_p[128], *l1z = l1z_p, l1x_p[128],
                     *l1x = l1x_p, d1_p[128], *d1 = d1_p;
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dzx_indirect_IEE_bigfloat(p1, p2x, p2y, p3x, p3y);
#endif
...
inline int orient2dzx_indirect_IEE(const genericPoint &p1, double p2x,
                                   double p2y, double p3x, double p3y) {
  int ret;
...
inline int orient2dzx_indirect_IIE_bigfloat(const genericPoint &p1,
                                            const genericPoint &p2,
                                            bigfloat op3x, bigfloat op3y) {
...
inline int orient2dzx_indirect_IIE_exact(const genericPoint &p1,
                                         const genericPoint &p2, double op3x,
                                         double op3y) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
#endif
  double l1y_p[64], *l1y = l1y_p, l1z_p[64], *l1z = l1z_p, l1x_p[64],
                    *l1x = l1x_p, d1_p[64], *d1 = d1_p, l2y_p[64], *l2y = l2y_p,
                    l2z_p[64], *l2z = l2z_p, l2x_p[64], *l2x = l2x_p, d2_p[64],
                    *d2 = d2_p;
  int l1y_len = 64, l1z_len = 64, l1x_len = 64, d1_len = 64, l2y_len = 64,
      l2z_len = 64, l2x_len = 64, d2_len = 64;
  p1.getExactLambda(&l1y, l1y_len, &l1z, l1z_len, &l1x, l1x_len, &d1, d1_len);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dzx_indirect_IIE_bigfloat(p1, p2, op3x, op3y);
#endif
...
inline int orient2dzx_indirect_IIE(const genericPoint &p1,
                                   const genericPoint &p2, double op3x,
                                   double op3y) {
  int ret;
...
inline int orient2dzx_indirect_III_interval(const genericPoint &p1,
                                            const genericPoint &p2,
                                            const genericPoint &p3) {
...
inline int orient2dzx_indirect_III_bigfloat(const genericPoint &p1,
                                            const genericPoint &p2,
                                            const genericPoint &p3) {
...
inline int orient2dzx_indirect_III_exact(const genericPoint &p1,
                                         const genericPoint &p2,
                                         const genericPoint &p3) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  double l1y_p[64], *l1y = l1y_p, l1z_p[64], *l1z = l1z_p, l1x_p[64],
                    *l1x = l1x_p, d1_p[64], *d1 = d1_p, l2y_p[64], *l2y = l2y_p,
                    l2z_p[64], *l2z = l2z_p, l2x_p[64], *l2x = l2x_p, d2_p[64],
                    *d2 = d2_p, l3y_p[64], *l3y = l3y_p, l3z_p[64],
                    *l3z = l3z_p, l3x_p[64], *l3x = l3x_p, d3_p[64], *d3 = d3_p;
  int l1y_len = 64, l1z_len = 64, l1x_len = 64, d1_len = 64, l2y_len = 64,
      l2z_len = 64, l2x_len = 64, d2_len = 64, l3y_len = 64, l3z_len = 64,
      l3x_len = 64, d3_len = 64;
  p1.getExactLambda(&l1y, l1y_len, &l1z, l1z_len, &l1x, l1x_len, &d1, d1_len);
  p2.getExactLambda(&l2y, l2y_len, &l2z, l2z_len, &l2x, l2x_len, &d2, d2_len);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2dzx_indirect_III_bigfloat(p1, p2, p3);
#endif
...
inline int orient2dzx_indirect_III(const genericPoint &p1,
                                   const genericPoint &p2,
                                   const genericPoint &p3) {
  int ret;
...
inline int orient2d_indirect_IEE_bigfloat(const genericPoint &p1, bigfloat p2x,
                                          bigfloat p2y, bigfloat p3x,
                                          bigfloat p3y) {
  bigfloat l1x, l1y, d1;
  p1.getBigfloatLambda(l1x, l1y, d1);
  const bigfloat t1x(p2y - p3y);
...
inline int orient2d_indirect_IEE_exact(const genericPoint &p1, double p2x,
                                       double p2y, double p3x, double p3y) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2d_indirect_IEE_bigfloat(p1, p2x, p2y, p3x, p3y);
#endif
...
inline int orient2d_indirect_IEE(const genericPoint &p1, double p2x, double p2y,
...
inline int orient2d_indirect_IIE_bigfloat(const genericPoint &p1,
                                          const genericPoint &p2, bigfloat p3x,
                                          bigfloat p3y) {
  bigfloat l1x, l1y, d1, l2x, l2y, d2;
  p1.getBigfloatLambda(l1x, l1y, d1);
  p2.getBigfloatLambda(l2x, l2y, d2);
...
inline int orient2d_indirect_IIE_exact(const genericPoint &p1,
                                       const genericPoint &p2, double p3x,
                                       double p3y) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2d_indirect_IIE_bigfloat(p1, p2, p3x, p3y);
#endif
...
inline int orient2d_indirect_IIE(const genericPoint &p1, const genericPoint &p2,
                                 double p3x, double p3y) {
  int ret;
...
inline int orient2d_indirect_III_interval(const genericPoint &p1,
                                          const genericPoint &p2,
                                          const genericPoint &p3) {
  interval_number l1x, l1y, d1, l2x, l2y, d2, l3x, l3y, d3;
  if (!p1.getIntervalLambda(l1x, l1y, d1) ||
...
inline int orient2d_indirect_III_bigfloat(const genericPoint &p1,
                                          const genericPoint &p2,
                                          const genericPoint &p3) {
  bigfloat l1x, l1y, d1, l2x, l2y, d2, l3x, l3y, d3;
  p1.getBigfloatLambda(l1x, l1y, d1);
...
inline int orient2d_indirect_III_exact(const genericPoint &p1,
                                       const genericPoint &p2,
                                       const genericPoint &p3) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient2d_indirect_III_bigfloat(p1, p2, p3);
#endif
...
inline int orient2d_indirect_III(const genericPoint &p1, const genericPoint &p2,
                                 const genericPoint &p3) {
  int ret;
...
inline int
orient3d_indirect_IEEE_interval(const genericPoint &p1, interval_number ax,
                                interval_number ay, interval_number az,
                                interval_number bx, interval_number by,
                                interval_number bz, interval_number cx,
                                interval_number cy, interval_number cz) {
  interval_number l1x, l1y, l1z, d1;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1))
    return Filtered_Sign::UNCERTAIN;
...
inline int orient3d_indirect_IEEE_bigfloat(const genericPoint &p1, bigfloat ax,
                                           bigfloat ay, bigfloat az,
                                           bigfloat bx, bigfloat by,
                                           bigfloat bz, bigfloat cx,
                                           bigfloat cy, bigfloat cz) {
  bigfloat l1x, l1y, l1z, d1;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
...
inline int orient3d_indirect_IEEE_exact(const genericPoint &p1, double ax,
                                        double ay, double az, double bx,
                                        double by, double bz, double cx,
                                        double cy, double cz) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value =
        orient3d_indirect_IEEE_bigfloat(p1, ax, ay, az, bx, by, bz, cx, cy, cz);
#endif
...
inline int orient3d_indirect_IEEE(const genericPoint &p1, double ax, double ay,
...
inline int
orient3d_indirect_IIEE_interval(const genericPoint &p1, const genericPoint &p2,
                                interval_number p3x, interval_number p3y,
                                interval_number p3z, interval_number p4x,
                                interval_number p4y, interval_number p4z) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
      !p2.getIntervalLambda(l2x, l2y, l2z, d2))
    return Filtered_Sign::UNCERTAIN;
...
inline int orient3d_indirect_IIEE_bigfloat(const genericPoint &p1,
                                           const genericPoint &p2, bigfloat p3x,
                                           bigfloat p3y, bigfloat p3z,
                                           bigfloat p4x, bigfloat p4y,
                                           bigfloat p4z) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
  p2.getBigfloatLambda(l2x, l2y, l2z, d2);
...
inline int orient3d_indirect_IIEE_exact(const genericPoint &p1,
                                        const genericPoint &p2, double p3x,
                                        double p3y, double p3z, double p4x,
  ...
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value =
        orient3d_indirect_IIEE_bigfloat(p1, p2, p3x, p3y, p3z, p4x, p4y, p4z);
#endif
...
inline int
orient3d_indirect_IIIE_interval(const genericPoint &p1, const genericPoint &p2,
                                const genericPoint &p3, interval_number p4x,
                                interval_number p4y, interval_number p4z) {
  interval_number l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
  if (!p1.getIntervalLambda(l1x, l1y, l1z, d1) ||
      !p2.getIntervalLambda(l2x, l2y, l2z, d2) ||
...
inline int orient3d_indirect_IIIE_bigfloat(const genericPoint &p1,
                                           const genericPoint &p2,
                                           const genericPoint &p3, bigfloat p4x,
                                           bigfloat p4y, bigfloat p4z) {
  bigfloat l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
  p1.getBigfloatLambda(l1x, l1y, l1z, d1);
  p2.getBigfloatLambda(l2x, l2y, l2z, d2);
  p3.getBigfloatLambda(l3x, l3y, l3z, d3);
...
inline int orient3d_indirect_IIIE_exact(const genericPoint &p1,
                                        const genericPoint &p2,
                                        const genericPoint &p3, double p4x,
                                        double p4y, double p4z) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient3d_indirect_IIIE_bigfloat(p1, p2, p3, p4x, p4y, p4z);
#endif
...
inline int orient3d_indirect_IIII_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) &&
    ...
    double p1p4x_p[32], *p1p4x = p1p4x_p;
    int p1p4x_len = o.Gen_Diff_With_PreAlloc(d4l1x_len, d4l1x, d1p4x_len, d1p4x,
                                             &p1p4x, 32);
    double p1p4y_p[32], *p1p4y = p1p4y_p;
    int p1p4y_len = o.Gen_Diff_With_PreAlloc(d4l1y_len, d4l1y, d1p4y_len, d1p4y,
                                             &p1p4y, 32);
    double p1p4z_p[32], *p1p4z = p1p4z_p;
    int p1p4z_len = o.Gen_Diff_With_PreAlloc(d4l1z_len, d4l1z, d1p4z_len, d1p4z,
                                             &p1p4z, 32);
    double p2p4x_p[32], *p2p4x = p2p4x_p;
    int p2p4x_len = o.Gen_Diff_With_PreAlloc(d4l2x_len, d4l2x, d2p4x_len, d2p4x,
                                             &p2p4x, 32);
    double p2p4y_p[32], *p2p4y = p2p4y_p;
    int p2p4y_len = o.Gen_Diff_With_PreAlloc(d4l2y_len, d4l2y, d2p4y_len, d2p4y,
                                             &p2p4y, 32);
    double p2p4z_p[32], *p2p4z = p2p4z_p;
    int p2p4z_len = o.Gen_Diff_With_PreAlloc(d4l2z_len, d4l2z, d2p4z_len, d2p4z,
                                             &p2p4z, 32);
    double p3p4x_p[32], *p3p4x = p3p4x_p;
    int p3p4x_len = o.Gen_Diff_With_PreAlloc(d4l3x_len, d4l3x, d3p4x_len, d3p4x,
                                             &p3p4x, 32);
    double p3p4y_p[32], *p3p4y = p3p4y_p;
    int p3p4y_len = o.Gen_Diff_With_PreAlloc(d4l3y_len, d4l3y, d3p4y_len, d3p4y,
                                             &p3p4y, 32);
    double p3p4z_p[32], *p3p4z = p3p4z_p;
    int p3p4z_len = o.Gen_Diff_With_PreAlloc(d4l3z_len, d4l3z, d3p4z_len, d3p4z,
                                             &p3p4z, 32);
    double tmc_a_p[32], *tmc_a = tmc_a_p;
    int tmc_a_len = o.Gen_Product_With_PreAlloc(p1p4x_len, p1p4x, p2p4y_len,
                                                p2p4y, &tmc_a, 32);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = orient3d_indirect_IIII_bigfloat(p1, p2, p3, p4);
#endif
