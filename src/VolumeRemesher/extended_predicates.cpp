...
int triangles_overlap(const double *v11, const double *v12, const double *v13,
  ...
  if (pointInInnerTriangle(v11, v21, v22, v23) ||
      pointInInnerTriangle(v12, v21, v22, v23) ||
      pointInInnerTriangle(v13, v21, v22, v23) ||
      pointInInnerTriangle(v21, v11, v12, v13) ||
      pointInInnerTriangle(v22, v11, v12, v13) ||
      pointInInnerTriangle(v23, v11, v12, v13))
    return 1;

  // If edges corss -> TRUE
  if (innerSegmentsCross(v11, v12, v21, v22) ||
      innerSegmentsCross(v12, v13, v21, v22) ||
      innerSegmentsCross(v13, v11, v21, v22) ||
      innerSegmentsCross(v11, v12, v22, v23) ||
      innerSegmentsCross(v12, v13, v22, v23) ||
      innerSegmentsCross(v13, v11, v22, v23) ||
      innerSegmentsCross(v11, v12, v23, v21) ||
      innerSegmentsCross(v12, v13, v23, v21) ||
      innerSegmentsCross(v13, v11, v23, v21))
    return 1;

  if (pointInTriangle(v11, v21, v22, v23) &&
      pointInTriangle(v12, v21, v22, v23) &&
      pointInTriangle(v13, v21, v22, v23))
    return 1;
  if (pointInTriangle(v21, v11, v12, v13) &&
      pointInTriangle(v22, v11, v12, v13) &&
...
static inline uint32_t pointInTriangleCC(const double *p, const double *v1,
                                         const double *v2, const double *v3) {
...
int triangle_intersects_inner_tet(const double *v1, const double *v2,
  ...
  if ((pointInTriangleCC(v1, t1, t2, t3) || pointInTriangleCC(v1, t2, t3, t4) ||
       pointInTriangleCC(v1, t4, t1, t2) ||
       pointInTriangleCC(v1, t1, t4, t3)) &&
      (pointInTriangleCC(v2, t1, t2, t3) || pointInTriangleCC(v2, t2, t3, t4) ||
       pointInTriangleCC(v2, t4, t1, t2) ||
       pointInTriangleCC(v2, t1, t4, t3)) &&
