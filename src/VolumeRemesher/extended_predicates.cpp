...
{
    return (
        misAlignment(p, v1, v2) == 0 && ((v1[0] < v2[0] && v1[0] < p[0] && p[0] < v2[0]) ||
...
// Output: 1 -> points p and q lies both on the same side of the straight line passing througt v1
// and v2.
//         0 -> otherwise.
...
uint32_t innerSegmentsCross(const double* u1, const double* u2, const double* v1, const double* v2)
{
    ...
    if (same_point(u1, v1) || same_point(u1, v2) || same_point(u2, v1) || same_point(u2, v2))
        return 0;
    ...
    if (same_half_plane(u1, u2, v1, v2) || same_half_plane(v1, v2, u1, u2)) return 0;
...
{
    return (
        pointInSegment(p, v1, v2) || pointInSegment(p, v2, v3) || pointInSegment(p, v3, v1) ||
...
// Output: 1 -> segment and triangle properly intesects, i.e. intersection occours in both segment
// and triangle interior,
//        0 -> otherwise.
// Note. Collinear overlapping segments are not considered to be properly intersecting.
uint32_t innerSegmentCrossesInnerTriangle(
    const double* u1,
    const double* u2,
    const double* v1,
    const double* v2,
    const double* v3)
{
    ...
    // Endpoints of one segment cannot stay both in one of the same half-space defined by the
    // triangle.
...
//         0 -> otherwise.
uint32_t innerSegmentCrossesTriangle(
    const double* u1,
    const double* u2,
    const double* v1,
    const double* v2,
    const double* v3)
{
    if (pointInInnerSegment(v1, u1, u2) || pointInInnerSegment(v2, u1, u2) ||
        ...
        innerSegmentsCross(v3, v1, u1, u2) || innerSegmentsCross(v1, v2, u1, u2) ||
    ...
    const double* v23)
{
    ...
    if (orient3d(v11, v12, v13, v21) || orient3d(v11, v12, v13, v22) ||
        orient3d(v11, v12, v13, v23))
        return 0;

    // If one has vertex into the other -> TRUE
    if (pointInInnerTriangle(v11, v21, v22, v23) || pointInInnerTriangle(v12, v21, v22, v23) ||
        pointInInnerTriangle(v13, v21, v22, v23) || pointInInnerTriangle(v21, v11, v12, v13) ||
        pointInInnerTriangle(v22, v11, v12, v13) || pointInInnerTriangle(v23, v11, v12, v13))
        return 1;

    // If edges corss -> TRUE
    if (innerSegmentsCross(v11, v12, v21, v22) || innerSegmentsCross(v12, v13, v21, v22) ||
        innerSegmentsCross(v13, v11, v21, v22) || innerSegmentsCross(v11, v12, v22, v23) ||
        innerSegmentsCross(v12, v13, v22, v23) || innerSegmentsCross(v13, v11, v22, v23) ||
        innerSegmentsCross(v11, v12, v23, v21) || innerSegmentsCross(v12, v13, v23, v21) ||
        innerSegmentsCross(v13, v11, v23, v21))
        return 1;

    if (pointInTriangle(v11, v21, v22, v23) && pointInTriangle(v12, v21, v22, v23) &&
        pointInTriangle(v13, v21, v22, v23))
        return 1;
    if (pointInTriangle(v21, v11, v12, v13) && pointInTriangle(v22, v11, v12, v13) &&
        pointInTriangle(v23, v11, v12, v13))
        return 1;
...
pointInTriangleCC(const double* p, const double* v1, const double* v2, const double* v3)
{
    ...
    const double* t4)
{
    ...
    if (innerSegmentCrossesInnerTriangle(t1, t2, v1, v2, v3) ||
        ...
        innerSegmentCrossesInnerTriangle(t4, t1, v1, v2, v3))
        return 1;
    ...
    if (innerSegmentCrossesInnerTriangle(v1, v2, t1, t2, t3) ||
        ...
        innerSegmentCrossesInnerTriangle(v1, v2, t1, t2, t4))
        return 1;
    ...
    if (innerSegmentCrossesInnerTriangle(v2, v3, t1, t2, t3) ||
        ...
        innerSegmentCrossesInnerTriangle(v2, v3, t1, t2, t4))
        return 1;
    ...
    if (innerSegmentCrossesInnerTriangle(v3, v1, t1, t2, t3) ||
        ...
        innerSegmentCrossesInnerTriangle(v3, v1, t1, t2, t4))
        return 1;

    // All three triangle vertices are on tet faces
    if ((pointInTriangleCC(v1, t1, t2, t3) || pointInTriangleCC(v1, t2, t3, t4) ||
         pointInTriangleCC(v1, t4, t1, t2) || pointInTriangleCC(v1, t1, t4, t3)) &&
        (pointInTriangleCC(v2, t1, t2, t3) || pointInTriangleCC(v2, t2, t3, t4) ||
         pointInTriangleCC(v2, t4, t1, t2) || pointInTriangleCC(v2, t1, t4, t3)) &&
        (pointInTriangleCC(v3, t1, t2, t3) || pointInTriangleCC(v3, t2, t3, t4) ||
         pointInTriangleCC(v3, t4, t1, t2) || pointInTriangleCC(v3, t1, t4, t3)))
        return 1;
